      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('area.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
              ...
              @endif
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="page_city_id" id="showcity_data" required>
                    ...
                    <option value="{{$city->id}}" {{($result_page->parent_id == $city->id ? "selected":"")}}>{{$city->name}}</option>
                    @endforeach
                  </select>
                </div>
