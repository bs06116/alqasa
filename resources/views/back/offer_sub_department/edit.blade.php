      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('offerSubDepartment.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
                ...
                <div class="form-group col-md-12">
                  ...
                  <select class="form-control" name="page_offer_department_id" required>
                    ...
                    <option value="{{$offer_department->id}}" {{($result_page->parent_id == $offer_department->id ? "selected":"")}}>{{$offer_department->name}}</option>
                    @endforeach
                  </select>
                </div>
