      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('generalDepartment.store') }}" method="post" enctype="multipart/form-data">
			      @csrf
              <div class="box-body">	
                ...
                <div class="form-group col-md-6">
                  ...
                  <option value="1">استايل المساجد</option>
                  <option value="2">استايل المقابر</option>
                  </select>
                </div>
