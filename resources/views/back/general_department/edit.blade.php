      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('generalDepartment.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <option value="1" {{$result_page->type == 1 ? "selected" : ""}}>استايل المساجد</option>
                  <option value="2" {{$result_page->type == 2 ? "selected" : ""}}>استايل المقابر</option>
                  </select>
                </div>
