      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('client.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="box-body">
            ...
            @if(session('errorMessage'))
              ...
              <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="page_phone" value="{{$result_page->phone}}" data-inputmask='"mask": "99999999"' data-mask required>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="page_address" value="{{$result_page->address}}" placeholder="العنوان" required>
                </div>
