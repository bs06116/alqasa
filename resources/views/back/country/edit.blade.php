      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('country.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="page_country_code" value="{{$result_page->country_code}}" placeholder="كود الدولة" required>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  @if($result_page->flag != "")
                  <img src="{{url('public/'.$result_page->flag)}}" style="width: 100px; height: 100px;">
                  @endif
                  <br>
