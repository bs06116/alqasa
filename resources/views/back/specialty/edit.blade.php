      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('specialty.update',$result_page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="box-body">
                ...
                <div class="form-group col-md-12">
                  ...
                  @if($result_page->icon != "")
                  <img src="{{url('public/'.$result_page->icon)}}" style="width: 100px; height: 100px;">
                  @endif
                  <br>
